...
<template>
  <li>
    ...
    <div class="todo-actions">
      <Icon v-if="todo.isEditing" icon="ph:check-circle" class="icon" color="#0cc71c" width="22" @click="$emit('edit-todo', index)" />
      <Icon v-else icon="ph:pencil-fill" class="icon" color="#0cc71c" width="22" @click="$emit('edit-todo', index)" />
